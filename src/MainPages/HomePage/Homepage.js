    ...
    <>
      <div className="Home">
        <div className="intro">
          ...
          <h1>
            I'M <span style={{ color: "red" }}>LAVORI PAVAN</span>
          </h1>
          <h1 id="typing">
            <Type />
          </h1>
        ...
        <div className="introDetails">
          ...
          <p>
            ...
            <span style={{ color: "red" }}>Java</span> and{" "}
        ...
        <div className="socialLinks">
          ...
          <div className="Links">
            <ul className="Link">
              <li id="link1">
                <a
                  href="https://github.com/pavannayak9502"
                  alt="User_Git_page"
                  target="_blank"
                  rel="noreferrer"
                  id="Link1"
              ...
              <li id="link2">
                <a
                  href="https://www.linkedin.com/in/lavori-pavan/"
                  alt="User_LinkedIn_Page"
                  target="_blank"
                  rel="noreferrer"
                  id="Link2"
                >
              ...
              <li id="link4">
                <a
                  href="https://www.instagram.com/pavannayak1234/"
                  alt="instagram_page"
                  target="_blank"
                  rel="noreferrer"
                  id="Link4"
