...
import demoImage from "../../Components/Images/demoImage.png";
...
let About = () => {
  return (
    <>
      ...
      <h1 id="Header1">
        Know Who <span style={{ color: "red" }}>I'M</span>
      </h1>

      <div className="userIntro" id="userIntro">
        <p id="Paragraph1">
          Hi Eveyone, I am <span style={{ color: "red" }}>Lavori Pavan</span>{" "}
          from <span style={{ color: "red" }}>Hyderabad, India.</span> <br></br>
          <br></br>I have done my bachelor's in{" "}
          <span style={{ color: "red" }}>Computer Science</span> from{" "}
          <span style={{ color: "red" }}>IIIT SRICITY CHITOOR.</span>
        </p>
        <img src={demoImage} alt="Intro_Img" id="userDemo_Image3" />
      </div>

      <div className="user_Hobbies">
        <p>Apart from coding, some other activites that I love to do!</p>
        <ul className="Hobbies">
          <li className="Hobbie">╰┈➤ Playing Games</li>
          <li className="Hobbie">╰┈➤ Travelling</li>
          <li className="Hobbie">╰┈➤ Yoga</li>
          <li className="Hobbie">╰┈➤ Gardening Work</li>
        </ul>
        <p>"Strive to build things that make a difference!"</p>
        <p id="Paragraph2">
          ⤐⤐⤐⤐ <code style={{ color: "red" }}>Lavori Pavan</code> ⬷⬷⬷
        </p>
      </div>

      <h1 id="Header2" style={{ textAlign: "center" }}>
        Professional{" "}
      ...
      <div className="professionalSkills">
        <div title="HTML5" className="skill">
          <svg
        ...
        <div title="CSS3" className="skill">
          <svg
            xmlns="http://www.w3.org/2000/svg"
            height="100px"
            viewBox="0 -960 960 960"
        ...
        <div title="JAVA" className="skill">
          <svg
            width="100px"
            height="100px"
            viewBox="0 0 32 32"
        ...
        <div title="JAVA SCRIPT" className="skill">
          <svg
            xmlns="http://www.w3.org/2000/svg"
            height="100px"
            viewBox="0 -960 960 960"
        ...
        <div title="Data Structure and Algorithms" className="skill">
          <svg
            xmlns="http://www.w3.org/2000/svg"
            height="100px"
            viewBox="0 0 64 64"
          ...
          >
            <g id="Layer_19" data-name="Layer 19">
              <path
                d="M61,34H56V31a1,1,0,0,0-1-1H33V19.982c2.528-.082,8-.54,8-2.982V5c0-2.855-7.5-3-9-3s-9,.145-9,3V17c0,2.442,5.472,2.9,8,2.982V30H9a1,1,0,0,0-1,1v3H3a1,1,0,0,0-1,1v6a1,1,0,0,0,1,1H15a1,1,0,0,0,1-1V35a1,1,0,0,0-1-1H10V32H31v2H26a1,1,0,0,0-1,1v6a1,1,0,0,0,1,1h5v6H11a1,1,0,0,0-1,1v3.1a5,5,0,1,0,2,0V50H31v2.1a5,5,0,1,0,2,0V50H52v2.1a5,5,0,1,0,2,0V49a1,1,0,0,0-1-1H33V42h5a1,1,0,0,0,1-1V35a1,1,0,0,0-1-1H33V32H54v2H49a1,1,0,0,0-1,1v6a1,1,0,0,0,1,1H61a1,1,0,0,0,1-1V35A1,1,0,0,0,61,34ZM38.718,5a9.638,9.638,0,0,1-2.8.738l.293,1.978A13.54,13.54,0,0,0,39,7.04v3.792c-.518.43-2.971,1.168-7,1.168s-6.482-.738-7-1.168V7.046A23.506,23.506,0,0,0,32,8c.679,0,1.338-.021,1.97-.059l-.121-2C33.256,5.98,32.638,6,32,6a17.468,17.468,0,0,1-6.728-1A17.423,17.423,0,0,1,32,4,17.517,17.517,0,0,1,38.718,5ZM25,13.04A23.285,23.285,0,0,0,32,14a23.285,23.285,0,0,0,7-.96v3.792c-.518.43-2.971,1.168-7,1.168s-6.482-.738-7-1.168ZM14,40H4V36H14Zm0,17a3,3,0,1,1-3-3A3,3,0,0,1,14,57Zm21,0a3,3,0,1,1-3-3A3,3,0,0,1,35,57Zm21,0a3,3,0,1,1-3-3A3,3,0,0,1,56,57ZM37,40H27V36H37Zm23,0H50V36H60Z"
                fill="white"
              />
            </g>
          </svg>
        </div>
        <div title="SQL" className="skill">
          <svg
            width="100px"
            height="100px"
            viewBox="0 0 20 20"
          ...
          >
            <g id="layer1">
              <path
                d="M 3 0 L 3 20 L 17 20 L 17 19 L 16 19 L 4 19 L 4 1 L 12 1 L 12 4 L 12 5 L 16 5 L 16 12 L 17 12 L 17 5 L 17 4 L 13 0 L 12 0 L 3 0 z M 13 1.3535156 L 15.646484 4 L 13 4 L 13 1.3535156 z M 6.5 13 C 5.671573 13 5 13.671573 5 14.5 C 5 15.328427 5.671573 16 6.5 16 L 7.5 16 C 7.776142 16 8 16.223858 8 16.5 C 8 16.776142 7.776142 17 7.5 17 L 5 17 L 5 18 L 7.5 18 C 8.328427 18 9 17.328427 9 16.5 C 9 15.671573 8.328427 15 7.5 15 L 6.5 15 C 6.223858 15 6 14.776142 6 14.5 C 6 14.223858 6.223858 14 6.5 14 L 9 14 L 9 13 L 6.5 13 z M 12 13 L 11.816406 13.007812 L 11.632812 13.033203 L 11.453125 13.076172 L 11.277344 13.134766 L 11.107422 13.208984 L 10.947266 13.298828 L 10.794922 13.404297 L 10.652344 13.521484 L 10.521484 13.652344 L 10.404297 13.794922 L 10.300781 13.947266 L 10.208984 14.107422 L 10.134766 14.277344 L 10.076172 14.451172 L 10.035156 14.632812 L 10.007812 14.816406 L 10 15 L 10 16 L 10.007812 16.183594 L 10.035156 16.367188 L 10.076172 16.546875 L 10.134766 16.722656 L 10.208984 16.890625 L 10.300781 17.052734 L 10.404297 17.205078 L 10.521484 17.347656 L 10.652344 17.478516 L 10.794922 17.595703 L 10.947266 17.699219 L 11.107422 17.791016 L 11.277344 17.865234 L 11.453125 17.923828 L 11.632812 17.964844 L 11.816406 17.992188 L 12 18 L 12.183594 17.992188 L 12.367188 17.964844 L 12.546875 17.923828 L 12.722656 17.865234 L 12.892578 17.791016 L 13.013672 17.720703 L 13.146484 17.853516 A 0.50005 0.50005 0 0 0 13.5 18 L 14 18 L 14 17 L 13.728516 17 L 13.791016 16.890625 L 13.865234 16.722656 L 13.923828 16.546875 L 13.964844 16.367188 L 13.992188 16.183594 L 14 16 L 14 15 L 13.992188 14.816406 L 13.964844 14.632812 L 13.923828 14.451172 L 13.865234 14.277344 L 13.791016 14.107422 L 13.699219 13.947266 L 13.595703 13.794922 L 13.478516 13.652344 L 13.347656 13.521484 L 13.205078 13.404297 L 13.052734 13.298828 L 12.892578 13.208984 L 12.722656 13.134766 L 12.546875 13.076172 L 12.367188 13.033203 L 12.183594 13.007812 L 12 13 z M 15 13 L 15 18 L 19 18 L 19 17 L 16 17 L 16 13 L 15 13 z M 12 14 L 12.130859 14.007812 L 12.259766 14.033203 L 12.382812 14.076172 L 12.5 14.134766 L 12.609375 14.207031 L 12.707031 14.292969 L 12.792969 14.390625 L 12.865234 14.5 L 12.923828 14.617188 L 12.966797 14.740234 L 12.992188 14.869141 L 13 15 L 13 16 L 12.992188 16.130859 L 12.966797 16.257812 L 12.353516 15.646484 L 11.646484 16.353516 L 12.257812 16.964844 L 12.130859 16.992188 L 12 17 L 11.869141 16.992188 L 11.740234 16.964844 L 11.617188 16.923828 L 11.5 16.865234 L 11.390625 16.792969 L 11.292969 16.707031 L 11.207031 16.607422 L 11.134766 16.5 L 11.076172 16.382812 L 11.033203 16.257812 L 11.007812 16.130859 L 11 16 L 11 15 L 11.007812 14.869141 L 11.033203 14.740234 L 11.076172 14.617188 L 11.134766 14.5 L 11.207031 14.390625 L 11.292969 14.292969 L 11.390625 14.207031 L 11.5 14.134766 L 11.617188 14.076172 L 11.740234 14.033203 L 11.869141 14.007812 L 12 14 z "
                fill="white"
              />
            </g>
          </svg>
        </div>
        <div title="React Framework" className="skill">
          <svg
            fill="white"
            width="100px"
            height="100px"
        ...
        <div title="Git Hub" className="skill">
          <svg
            fill="white"
            width="100px"
            height="100px"
      ...
      <h1 style={{ textAlign: "center", marginTop: "55px" }}>
        <span style={{ color: "red" }}>Tools</span> I Use
      </h1>

      <div className="Tools" style={{ marginTop: "55px" }}>
        <div title="Vs Code Editor" className="skill">
          <svg
            width="100px"
            height="100px"
            viewBox="0 0 32 32"
        ...
        <div title="Ubuntu" className="skill">
          <svg
            width="100px"
            height="100px"
            xmlns="http://www.w3.org/2000/svg"
        ...
        <div title="Windows" className="skill">
          <svg
            width="100px"
            height="100px"
            viewBox="0 0 15 15"
