...
{/*Close Icon*/}    <li onClick={hideSidebar} className="closeIcon" ><a href="#close" style={{backgroundColor:"transparent"}}><svg xmlns="http://www.w3.org/2000/svg" height="24px" viewBox="0 -960 960 960" width="24px" fill="white"><path d="m256-200-56-56 224-224-224-224 56-56 224 224 224-224 56 56-224 224 224 224-56 56-224-224-224 224Z"/></svg></a></li>
                    <li onClick={hideSidebar}><Link to="/home" className="Link"><span className="Text">Home</span></Link></li>
                    <li onClick={hideSidebar}><Link to="/about" className="Link"><span className="Text">About</span></Link></li>
                    <li onClick={hideSidebar}><Link to="/project" className="Link"><span className="Text">Projects</span></Link></li>
                    <li onClick={hideSidebar}><Link to="/resume" className="Link"><span className="Text">Resume</span></Link></li>
...
{/*Home Icon Page*/} <li  id="link"><Link to="/" className="Link"><svg xmlns="http://www.w3.org/2000/svg" height="24px" viewBox="0 -960 960 960" width="24px" fill="white"><path d="M240-200h120v-240h240v240h120v-360L480-740 240-560v360Zm-80 80v-480l320-240 320 240v480H520v-240h-80v240H160Zm320-350Z"/></svg></Link></li>
                    <li className="hideOnMobile"><Link to="/home" className="Link"><span className="Me" id="Me1">Home</span></Link></li>
                    <li className="hideOnMobile"><Link to="/about" className="Link"><span className="Me" id="Me2">About</span></Link></li>
                    <li className="hideOnMobile"><Link to="/project" className="Link"><span className="Me" id="Me3">Projects</span></Link></li>
                    <li className="hideOnMobile"><Link to="/resume" className="Link"><span className="Me" id="Me4">Resume</span></Link></li>
